...
import org.kordamp.jarviz.cli.checksum.Checksum;
...
import org.kordamp.jarviz.cli.packages.Packages;
...
@CommandLine.Command(name = "jarviz",
    subcommands = {
        Bytecode.class, Checksum.class, Entries.class, Manifest.class,
